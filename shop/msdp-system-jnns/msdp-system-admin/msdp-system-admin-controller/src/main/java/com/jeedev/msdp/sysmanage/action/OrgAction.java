...
public class OrgAction extends BaseAppAction {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "/selectorCoreOrg")
	public ResponseVO selectorCoreOrg(@RequestParam Map<String,Object> reqMap,PageParam page) throws Exception{
		PageInfo<Map<String, Object>> orgs = orgApi.findCoreOrgPage(reqMap, page);
		Map<String, Object> result = new HashMap<String, Object>();
	    result.put("grid", orgs);
	    return this.successResponse(result); 
	}
