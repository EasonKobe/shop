...
define(function(require, exports, module) {
    ...
    app.service('routeService', [function() {
		var tmplUrl = ctx + "/static/pages/";
	   	var centerTemplateUrl = "\""+ctx+"/static/pages/center.html\"";
	   	var publicFooterUrl = "{\"templateUrl\": \""+ctx+"/static/pages/template/public_footer.html\"}";
	   	var centerFooterUrl = "{\"templateUrl\": \""+ctx+"/static/pages/template/center_footer.html\"}";
	   	var loginFooterUrl = "{\"templateUrl\": \""+ctx+"/static/pages/template/login_footer.html\"}";
	   	var publicHeaderUrl = "{\"templateUrl\": \""+ctx+"/static/pages/template/public_header.html\"}";
	   	var centerHeaderUrl = "{\"templateUrl\": \""+ctx+"/static/pages/template/center_header.html\"}";
	   	var publicMenuUrl = "{\"templateUrl\": \""+ctx+"/static/pages/template/public_menu.html\"}";
	   	var tmpCtrl = ctx + "/static/js/app/controller/";
	  ...
	  this.initAdminView = function initAdminView(url,templateUrl,ctrl){
		  ...
		  tarNm = tarNm + "?:_?:taskId?:vwtp?:userDefine";
		  var content = "";
		  if(!ctrl){
