...
define(function(require, exports, module) {
	var config = [
	 //[路由地址,页面地址,js地址]
 	 //系统管理start            
 	 ['/indexScf', 'index/index.html', ''],
 	 ['/login', 'login.html', 'indexController.js'],
 	 // 找回密码
 	 ...
 	 ['/user/pending/list', 'sysmanage/pending/pendingList.html', '/sysmanage/pending/pendingController.js'],
 	 ...
 	 ['/tenant/tenantmg/tenantViewMsg?id&tenantId', 'sysmanage/tenant/view/tenantAddMessage.html', 'sysmanage/tenant/tenantController.js']
 	 //系统管理end	      		
 		      		];
