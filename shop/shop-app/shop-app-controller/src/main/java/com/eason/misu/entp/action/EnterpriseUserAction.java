...
public class EnterpriseUserAction extends BaseAppAction {
    ...
    @ResponseBody
    @HeadInit(name= HeadConstants.HEAD_SCENE,value="tenantManage")
    public ResponseVO queryByRole(@RequestObjectParam Map<String,Object> RequstObjectMap ,@CurrentUser Map<String,Object> curUserMap,PageParam page) throws Exception {
        //请求参数不建议使用HttpServletRequest request
        try{
            Map<String, Object> result = new HashMap<String, Object>();
            page.setOrderBy("userNum  asc");
